...
\begin{frame}
 ...
 \begin{itemize}
  ...
  \item Offene Fragen:
  \begin{itemize}
  \item Welchen Effekt hat die vorherige Anwendung der reinen BWT mit verschiedenen Blockgrößen auf bekannte Kompressionsalgorithmen?
  ...
  \item Sind Bioinformatikdaten
  \end{itemize}
  \item Enwicklung von \textit{eBWT} zum Test
 \end{itemize}
\end{frame}
\begin{frame}
 \frametitle{Methodik}
...
\begin{frame}
 ...
 \begin{itemize}
  ...
  \item \textbf{Konklusion:} Um die BWT mit klassischen Kompressionsalgorithmen nutzen zu können ist eine andere Codierung, z.B. die \textit{Move-To-Front-Codierung} erforderlich
